...
<h1 style="font-size: 28; text-align: center; padding: 0em; padding-top: 3em;">DATA STRUCTURES </h1>
...
<option value=ALL <?php if(isset($_POST['first-dropdown']) && $_POST['first-dropdown'] === 'ALL') echo 'selected'; ?>>ALL</option>
  <option value=STACKS <?php if(isset($_POST['first-dropdown']) && $_POST['first-dropdown'] === 'PAGING') echo 'selected'; ?>>STACKS</option>
  <option value="TIME COMPLEXITY" <?php if(isset($_POST['first-dropdown']) && $_POST['first-dropdown'] === 'SCHEDULING') echo 'selected'; ?>>TIME COMPLEXITY</option>
  <option value=TREES <?php if(isset($_POST['first-dropdown']) && $_POST['first-dropdown'] === 'Deadlocks') echo 'selected'; ?>>TREES</option>
  <option value=GRAPHS <?php if(isset($_POST['first-dropdown']) && $_POST['first-dropdown'] === 'Deadlocks') echo 'selected'; ?>>GRAPHS</option>
